...
class SegNet(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        x1 = self.layer2(x1)
        # 72x72
        x1, mask1 = self.pool1(x1)
        x2 = self.layer3(x1)
        x2 = self.layer4(x2)
        # 36x36
        x2, mask2 = self.pool2(x2)
        x3 = self.layer5(x2)
        x3 = self.layer6(x3)
        x3 = self.layer7(x3)
        # 18x18
        x3, mask3 = self.pool3(x3)
        x4 = self.layer8(x3)
        x4 = self.layer9(x4)
        x4 = self.layer10(x4)
        # 9x9
        x4, mask4 = self.pool4(x4)
        x5 = self.layer11(x4)
        x5 = self.layer12(x5)
        x5 = self.layer13(x5)
        # 5x5
        x5, mask5 = self.pool5(x5)

        # decoder
        # 10x10
        x6 = self.up1([x5, mask5])
        # 9x9
        ...
        x6 = self.layer16(x6)
        # 18x18
        x7 = self.up2([x6, mask4])
        x7 = self.layer17(x7)
        x7 = self.layer18(x7)
        x7 = self.layer19(x7)
        # 36x36
        x8 = self.up3([x7, mask3])
        x8 = self.layer20(x8)
        x8 = self.layer21(x8)
        x8 = self.layer22(x8)
        # 72x72
        x9 = self.up4([x8, mask2])
        x9 = self.layer23(x9)
        x9 = self.layer24(x9)
        # 144x144
        x10 = self.up5([x9, mask1])
